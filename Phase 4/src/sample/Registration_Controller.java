...
public class Registration_Controller {
    ...
    @FXML
    private void addDropClicked(ActionEvent event) throws IOException {     //Hyper Link for class Schedule Search is clicked
        Stage stage;
        Parent root;
        stage=(Stage) ((Hyperlink)(event.getSource())).getScene().getWindow();
        ...
        AddDrop_Controller addDrop = loader1.getController();
        addDrop.setUsername(username);


        Scene scene = new Scene(root);
        stage.setScene(scene);
        stage.setTitle("Add/Drop/Withdraw Classes");
        stage.setWidth(1125.0D);
        stage.setHeight(700.0D);
        stage.show();
