...
public class TranscriptDetails {
    ...
    private ResultSet getClassInfoDB(int classid) throws SQLException {
        try {
            ...
            temp = statement.executeQuery("SELECT * FROM ClassTable where ClassID" + " = '" + classid + "'");
    ...
    private String getSubjectDB(int subjectID) throws SQLException{
        try {
            ...
            temp = statement.executeQuery("SELECT SubjectName FROM " + "SubjectTable " + "where " + "subjectID = '" + subjectID + "'");
            if (temp.next()) {
    ...
    private String getGradeDB(int gradeID) throws SQLException{
        try {
            ...
            temp = statement.executeQuery("SELECT FinalLetterGrade_For_Class FROM " + "FinalLetterGrade_for_class " + "where " + "FinalGrade_ID = '" + gradeID + "'");
            if (temp.next()) {
                return temp.getString(1);
            }
