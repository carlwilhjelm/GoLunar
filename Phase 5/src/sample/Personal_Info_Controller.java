...
public class Personal_Info_Controller {
    ...
    @FXML
    private void change_passHClicked(ActionEvent event) throws IOException {  //Hyper Link for change password is clicked
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Login.fxml"));
        Parent great = (Parent) loader.load();
        ...
        FXMLLoader loader1 = new FXMLLoader(getClass().getResource("ChangePass.fxml"));
        root = loader1.load();

        ChangePass_Controller changepass = loader1.getController();
