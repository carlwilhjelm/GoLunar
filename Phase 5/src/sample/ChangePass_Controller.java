...
public class ChangePass_Controller {
    ...
    @FXML
    private void mainBClicked(javafx.event.ActionEvent event) throws IOException, SQLException {       //Main Menu button is clicked
        try {
    ...
    @FXML
    private void recordsBClicked(javafx.event.ActionEvent event) throws IOException {        //Records button is clicked
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Login.fxml"));
        Parent great = (Parent) loader.load();
    ...
    @FXML
    private void infoBClicked(javafx.event.ActionEvent event) throws IOException {       //Personal Info button is clicked
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Login.fxml"));
        Parent great = (Parent) loader.load();
    ...
    @FXML
    private void registrationBClicked(javafx.event.ActionEvent event) throws IOException {       //Registration button is clicked
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Login.fxml"));
        Parent great = (Parent) loader.load();
    ...
    public void Submit_Pass_Change(javafx.event.ActionEvent actionEvent) throws SQLException {
        try {
            connect = SqliteConnection.Connector();
            st = (Statement) connect.createStatement();
            if (!pass1.getText().isEmpty() && !pass2.getText().isEmpty()) {
                ...
                if (password.equals(password2)) {
                   PreparedStatement pst = connect.prepareStatement("UPDATE StudentTable set Password_Plain = ? WHERE Username = ?");
    ...
    @FXML
    private void logoutClicked(javafx.event.ActionEvent event) throws IOException{
        Stage stage;
        Parent root;
        stage=(Stage) ((Button)(event.getSource())).getScene().getWindow();
